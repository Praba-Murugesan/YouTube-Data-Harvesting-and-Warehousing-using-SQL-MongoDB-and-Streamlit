...
# YouTube API key
api_key = 'AIzaSyA4aNQ8FXgzVPd6wvFflUuzNUCwzey0jKg'
...
def main():
    ...
    if choice == "Home":
        ...
        st.write("1. This approach can be used to collect large amounts of data from YouTube. The data can be stored in a variety of ways, including MongoDB and SQL.") 
        st.write("2. The data can be analyzed using a variety of tools, including Streamlit. This approach can be used to identify trends, make predictions, and improve decision-making")
